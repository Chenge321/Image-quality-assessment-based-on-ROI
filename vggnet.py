...
import cv2
import os
from segment import seperate 
#Cite: https://blog.csdn.net/sinat_36458870/java/article/details/78825571
...
if __name__ == '__main__':
    ...
    for image_path in images:
        ...
        cv2.imwrite(os.path.join(result_dir, 'result'+str(count)+'.jpg'), saliency_map)
        image2 =cv2.imread(os.path.join(result_dir, 'result'+str(count)+'.jpg'))
     
        count += 1
        
        seperate(image2,image)
