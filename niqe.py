...
if __name__ == "__main__":
    ...
    ref = np.array(Image.open('./images/contoursImage2.jpg').convert('LA'))[:,:,0] 
    print('NIQE of cut out image is: %0.3f'% niqe(ref))
    
    dis = np.array(Image.open('./images/timg.jpg').convert('LA'))[:,:,0] 
    print('NIQE of origin image is: %0.3f'% niqe(dis))
    
    print("the total score of the picture is : "+ str(0.4*niqe(dis)+0.6*niqe(ref)))
